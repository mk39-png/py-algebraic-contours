...
# NOTE: this was originally generate_example_figure, but has been repurposed to generate figures
# used for comparing similarity between C++ and Python implementations.
