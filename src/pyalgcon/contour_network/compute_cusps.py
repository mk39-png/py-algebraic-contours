...
def _compute_boundary_cusps(cusp_function_start_points: list[float],
                            ...
                            closed_contours: list[list[int]]) -> tuple[list[list[float]],
                                                                       ...
                                                                       list[bool]]:
    """
    Computes boundary cusps.

    :param cusp_function_start_points: TODO Description
    :type cusp_function_start_points: list[float]
    :param cusp_function_end_points: TODO Description
    :type cusp_function_end_points: list[float]
    :param cusp_function_start_points_param: TODO Description
    :type cusp_function_start_points_param: list[float]
    :param cusp_function_end_points_param: TODO Description
    :type cusp_function_end_points_param: list[float]
    :param closed_contours: TODO Description
    :type closed_contours: list[list[int]]
    :return: TODO Description
    :rtype: tuple[list[list[float]], list[bool], list[bool]]
    """
