...
def compare_vertex_charts_from_file(filepath: pathlib.Path,
    ...
    __compare_vertex_charts(vertex_charts_control, vertex_charts_test)


def __compare_edge_charts(edge_charts_control: list[dict],
...
def compare_edge_charts_from_file(filepath: pathlib.Path,
    ...
    __compare_edge_charts(edge_charts_control, edge_charts_test)


def __compare_face_charts(face_charts_control: list[dict],
...
def compare_face_charts_from_file(filepath: pathlib.Path,
    ...
    __compare_face_charts(face_charts_control, face_charts_test)
